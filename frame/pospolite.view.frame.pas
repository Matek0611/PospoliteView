...
type
  ...
  private
    ...
    FLayoutManager: TPLHTMLObjectLayoutManager;
    FPointer: TPLPointF;
...
begin
  ...
  if FLayoutManager.IsWorking then FLayoutManager.Change;
end;

procedure TPLHTMLFrame.BoundsChanged;
begin
  inherited BoundsChanged;

  //if FRenderingManager.IsRendering then FRenderingManager.RenderingFlag := false;
end;
...
begin
  ...
  FLayoutManager := TPLHTMLObjectLayoutManager.Create(FDocument);
end;
...
begin
  try
    ...
    //FBuffer.Canvas.TextOut(0, 0, TimeToStr(Now));
  except
