...
{$ifdef windows}
uses
  Windows, ActiveX, dynlibs, SysUtils;
...
const
  ...
  GUID_WICPixelFormat48bppRGBFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC912}';
  GUID_WICPixelFormat16bppGrayFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC913}';
  ...
  GUID_WICPixelFormat96bppRGBFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC918}';
  ...
  GUID_WICPixelFormat64bppRGBAFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC91D}';
  GUID_WICPixelFormat64bppRGBFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC940}';
  GUID_WICPixelFormat128bppRGBAFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC91E}';
  GUID_WICPixelFormat128bppRGBFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC941}';
  ...
  GUID_WICPixelFormat32bppGrayFixedPoint: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC93F}';
  ...
  GUID_WICPixelFormat32bpp3ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC92E}';
  GUID_WICPixelFormat40bpp4ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC92F}';
  GUID_WICPixelFormat48bpp5ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC930}';
  GUID_WICPixelFormat56bpp6ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC931}';
  GUID_WICPixelFormat64bpp7ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC932}';
  GUID_WICPixelFormat72bpp8ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC933}';
  GUID_WICPixelFormat64bpp3ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC934}';
  GUID_WICPixelFormat80bpp4ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC935}';
  GUID_WICPixelFormat96bpp5ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC936}';
  GUID_WICPixelFormat112bpp6ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC937}';
  GUID_WICPixelFormat128bpp7ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC938}';
  GUID_WICPixelFormat144bpp8ChannelsAlpha: TGUID =
    '{6FDDC324-4E03-4BFE-B185-3D77768DC939}';
...
const
  ...
  IID_IWICBitmapCodecProgressNotification: TGUID =
  ...
  IID_IWICDevelopRawNotificationCallback: TGUID =
...
type
  ...
  IPropertyBag2 = interface(IPropertyBag)
    ...
    function Read2(cProperties: ULONG; pPropBag: PPROPBAG2;
      pErrLog: IErrorLog; out pvarValue: variant;
      var phrError: HResult): HResult; stdcall;
    function Write2(cProperties: ULONG; pPropBag: PPROPBAG2;
    ...
    function GetPropertyInfo(iProperty: ULONG; cProperties: ULONG;
      out pPropBag: PPROPBAG2; out pcProperties: ULONG): HResult; stdcall;
  ...
  IWICPalette = interface(IUnknown)
    ...
    function InitializePredefined(ePaletteType: WICBitmapPaletteType;
      fAddTransparentColor: boolean): HResult; stdcall;
    ...
    function InitializeFromBitmap(pISurface: IWICBitmapSource;
      cCount: UINT; fAddTransparentColor: boolean): HResult; stdcall;
    ...
    function GetColors(cCount: UINT; out pColors: WICColor;
      out pcActualColors: UINT): HResult; stdcall;
  ...
  IWICBitmapSource = interface(IUnknown)
    ...
    function CopyPixels(prc: PWICRect; cPWideCharide, cbBufferSize: UINT;
  ...
  IWICFormatConverter = interface(IWICBitmapSource)
    ...
    function Initialize(pISource: IWICBitmapSource;
      const dstFormat: REFWICPixelFormatGUID; dither: WICBitmapDitherType;
      pIPalette: IWICPalette; alphaThresholdPercent: double;
  ...
  IWICBitmapScaler = interface(IWICBitmapSource)
    ...
    function Initialize(pISource: IWICBitmapSource; uiWidth, uiHeight: UINT;
  ...
  IWICBitmapLock = interface(IUnknown)
    ...
    function GetDataPointer(out pcbBufferSize: UINT;
  ...
  IWICColorContext = interface(IUnknown)
    ...
    function GetProfileBytes(cbBuffer: UINT; var pbBuffer: PByte;
  ...
  IWICStream = interface(IStream)
    ...
    function InitializeFromMemory(pbBuffer: PByte;
  ...
  IWICEnumMetadataItem = interface(IUnknown)
    ...
    function Next(var rgeltSchema: PROPVARIANT; var rgeltId: PROPVARIANT;
      var rgeltValue: PROPVARIANT; out pceltFetched: ULONG): HResult; stdcall;
  ...
  IWICMetadataQueryReader = interface(IUnknown)
    ...
    function GetLocation(cchMaxLength: UINT; var wzNamespace: PWideChar;
      out pcchActualLength: UINT): HResult; stdcall;
  ...
  IWICMetadataQueryWriter = interface(IWICMetadataQueryReader)
    ...
    function SetMetadataByName(wzName: PWideChar;
  ...
  IWICBitmapEncoder = interface(IUnknown)
    ...
    function SetColorContexts(cCount: UINT; ppIColorContext: IWICColorContext): HResult;
      stdcall;
    function SetPalette(pIPalette: IWICPalette): HResult; stdcall;
  ...
  IWICBitmapFrameEncode = interface(IUnknown)
    ...
    function SetPalette(pIPalette: IWICPalette): HResult; stdcall;
    function SetThumbnail(pIThumbnail: IWICBitmapSource): HResult; stdcall;
    function WritePixels(lineCount, cPWideCharide, cbBufferSize: UINT;
  ...
  IWICBitmapDecoder = interface(IUnknown)
    ...
    function Initialize(pIStream: IStream; cacheOptions: WICDecodeOptions): HResult;
      stdcall;
    function GetContainerFormat(out pguidContainerFormat: TGUID): HResult; stdcall;
    ...
    function GetColorContexts(cCount: UINT; var ppIColorContexts: IWICColorContext;
    ...
    function GetFrame(index: UINT; out ppIBitmapFrame: IWICBitmapFrameDecode): HResult;
      stdcall;
  end;
  ...
  IWICBitmapSourceTransform = interface(IUnknown)
    ...
    function CopyPixels(prcSrc: WICRect; uiWidth, uiHeight: UINT;
      pguidDstFormat: WICPixelFormatGUID; dstTransform: WICBitmapTransformOptions;
      nStride: UINT; cbBufferSize: UINT; out pbBuffer: PByte): HResult; stdcall;
    function GetClosestSize(out puiWidth: UINT; out puiHeight: UINT): HResult; stdcall;
    function GetClosestPixelFormat(out pguidDstFormat: WICPixelFormatGUID): HResult;
      stdcall;
    function DoesSupportTransform(dstTransform: WICBitmapTransformOptions;
      out pfIsSupported: boolean): HResult; stdcall;
  end;
  ...
  IWICBitmapCodecProgressNotification = interface(IUnknown)
    ...
    function RegisterProgressNotification(
      pfnProgressNotification: TProgressNotification;
      pvData: Pointer; dwProgressFlags: DWORD): HResult; stdcall;
  end;
  ...
  IWICComponentInfo = interface(IUnknown)
    ...
    function GetAuthor(cchAuthor: UINT; var wzAuthor: PWideChar;
      out pcchActual: UINT): HResult; stdcall;
    function GetVendorGUID(out pguidVendor: TGUID): HResult; stdcall;
    function GetVersion(cchVersion: UINT; wzVersion: PWideChar;
      out pcchActual: UINT): HResult; stdcall;
    function GetSpecVersion(cchSpecVersion: UINT; wzSpecVersion: PWideChar;
      out pcchActual: UINT): HResult; stdcall;
    function GetFriendlyName(cchFriendlyName: UINT; wzFriendlyName: PWideChar;
      out pcchActual: UINT): HResult; stdcall;
  end;
  ...
  IWICFormatConverterInfo = interface(IWICComponentInfo)
    ...
    function GetPixelFormats(cFormats: UINT; var pPixelFormatGUIDs: WICPixelFormatGUID;
  ...
  IWICBitmapCodecInfo = interface(IWICComponentInfo)
    ...
    function GetContainerFormat(out pguidContainerFormat: TGUID): HResult; stdcall;
    function GetPixelFormats(cFormats: UINT; var pguidPixelFormats: TGUID;
      out pcActual: UINT): HResult; stdcall;
    function GetColorManagementVersion(cchColorManagementVersion: UINT;
      var wzColorManagementVersion: PWideChar; out pcActual: UINT): HResult; stdcall;
    function GetDeviceManufacturer(cchDeviceManufacturer: UINT;
      var wzDeviceManufacturer: PWideChar; out pcActual: UINT): HResult; stdcall;
    function GetDeviceModels(cchDeviceModels: UINT; var wzDeviceModels: PWideChar;
      out pcActual: UINT): HResult; stdcall;
    function GetMimeTypes(cchMimeTypes: UINT; var wzMimeTypes: PWideChar;
      out pcActual: UINT): HResult; stdcall;
    function GetFileExtensions(cchFileExtensions: UINT;
      var wzFileExtensions: PWideChar; out pcActual: UINT): HResult; stdcall;
    ...
    function MatchesMimeType(wzMimeType: PWideChar;
      out pfMatches: boolean): HResult; stdcall;
  end;
  ...
  IWICBitmapDecoderInfo = interface(IWICBitmapCodecInfo)
    ...
    function GetPatterns(cbSizePatterns: UINT; var pPatterns: WICBitmapPattern;
      var pcPatterns, pcbPatternsActual: UINT): HResult; stdcall;
  ...
  IWICPixelFormatInfo = interface(IWICComponentInfo)
    ...
    function GetChannelMask(uiChannelIndex, cbMaskBuffer: UINT;
      var pbMaskBuffer: PByte; out pcbActual: UINT): HResult; stdcall;
  end;
  ...
  IWICImagingFactory = interface(IUnknown)
    ...
    function CreateDecoderFromFilename(wzFilename: PWideChar;
      pguidVendor: PGUID; dwDesiredAccess: DWORD; metadataOptions: WICDecodeOptions;
      out ppIDecoder: IWICBitmapDecoder): HResult; stdcall;
    function CreateDecoderFromStream(pIStream: IStream; pguidVendor: PGUID;
      metadataOptions: WICDecodeOptions; out ppIDecoder: IWICBitmapDecoder): HResult;
      stdcall;
    function CreateDecoderFromFileHandle(hFile: Pointer; pguidVendor: PGUID;
      metadataOptions: WICDecodeOptions; out ppIDecoder: IWICBitmapDecoder): HResult;
      stdcall;
    ...
    function CreateDecoder(const guidContainerFormat: TGUID;
      pguidVendor: PGUID; out ppIDecoder: IWICBitmapDecoder): HResult; stdcall;
    function CreateEncoder(const guidContainerFormat: TGUID;
      pguidVendor: PGUID; out ppIEncoder: IWICBitmapEncoder): HResult; stdcall;
    function CreatePalette(out ppIPalette: IWICPalette): HResult; stdcall;
    function CreateFormatConverter(out ppIFormatConverter: IWICFormatConverter): HResult;
      stdcall;
    function CreateBitmapScaler(out ppIBitmapScaler: IWICBitmapScaler): HResult; stdcall;
    function CreateBitmapClipper(out ppIBitmapClipper: IWICBitmapClipper): HResult;
      stdcall;
    ...
    function CreateColorContext(out ppIWICColorContext: IWICColorContext): HResult;
      stdcall;
    function CreateColorTransformer(
      out ppIWICColorTransform: IWICColorTransform): HResult; stdcall;
    function CreateBitmap(uiWidth, uiHeight: UINT;
      const pixelFormat: REFWICPixelFormatGUID; option: WICBitmapCreateCacheOption;
    ...
    function CreateBitmapFromSourceRect(pIBitmapSource: IWICBitmapSource;
      x, y, Width, Height: UINT; out ppIBitmap: IWICBitmap): HResult; stdcall;
    function CreateBitmapFromMemory(uiWidth, uiHeight: UINT;
      const pixelFormat: REFWICPixelFormatGUID; cPWideCharide, cbBufferSize: UINT;
      pbBuffer: PByte; out ppIBitmap: IWICBitmap): HResult; stdcall;
    function CreateBitmapFromHBITMAP(Bitmap: HBITMAP; hPalette: HPALETTE;
      options: WICBitmapAlphaChannelOption; out ppIBitmap: IWICBitmap): HResult; stdcall;
    function CreateBitmapFromHICON(Icon: HICON;
      out ppIBitmap: IWICBitmap): HResult; stdcall;
    function CreateComponentEnumerator(componentTypes, options: DWORD;
    ...
    function CreateFastMetadataEncoderFromFrameDecode(pIFrameDecoder:
      IWICBitmapFrameDecode;
      out ppIFastEncoder: IWICFastMetadataEncoder): HResult; stdcall;
    function CreateQueryWriter(const guidMetadataFormat, pguidVendor: TGUID;
    ...
    function CreateQueryWriterFromReader(pIQueryReader: IWICMetadataQueryReader;
      const pguidVendor: TGUID; out ppIQueryWriter: IWICMetadataQueryWriter): HResult;
      stdcall;
  end;
  ...
  IWICDevelopRaw = interface(IWICBitmapFrameDecode)
    ...
    function QueryRawCapabilitiesInfo(out pInfo: WICRawCapabilitiesInfo): HResult;
      stdcall;
    function LoadParameterSet(ParameterSet: WICRawParameterSet): HResult; stdcall;
    function GetCurrentParameterSet(out ppCurrentParameterSet: IPropertyBag2): HResult;
      stdcall;
    ...
    function GetKelvinRangeInfo(
      out pMinKelvinTemp, pMaxKelvinTemp, pKelvinTempStepValue: UINT): HResult; stdcall;
    ...
    function SetDestinationColorContext(pColorContext: IWICColorContext): HResult;
      stdcall;
    function SetToneCurve(cbToneCurveSize: UINT;
      pToneCurve: WICRawToneCurve): HResult; stdcall;
    function GetToneCurve(cbToneCurveBufferSize: UINT;
      var pToneCurve: WICRawToneCurve; out pcbActualToneCurveBufferSize: UINT): HResult;
      stdcall;
    ...
    function SetNotificationCallback(pCallback: IWICDevelopRawNotificationCallback):
      HResult; stdcall;
  end;
...
type
  ...
  IWICMetadataBlockWriter = interface(IWICMetadataBlockReader)
    ...
    function InitializeFromBlockReader(
      out pIMDBlockReader: IWICMetadataBlockReader): HResult; stdcall;
  ...
  IWICMetadataReader = interface(IUnknown)
    ...
    function GetMetadataHandlerInfo(out ppIHandler: IWICMetadataHandlerInfo): HResult;
      stdcall;
    function GetCount(out pcCount: UINT): HResult; stdcall;
    function GetValueByIndex(nIndex: UINT;
      var pvarSchema, pvarId, pvarValue: variant): HResult; stdcall;
    function GetValue(pvarSchema, pvarId: variant;
      var pvarValue: variant): HResult; stdcall;
  ...
  IWICMetadataWriter = interface(IWICMetadataReader)
    ...
    function SetValueByIndex(nIndex: UINT;
      pvarSchema, pvarId, pvarValue: variant): HResult; stdcall;
  ...
  IWICPersistStream = interface(IPersistStream)
    ...
    function LoadEx(pIStream: IStream; pguidPreferredVendor: TGUID;
      dwPersistOptions: DWORD): HResult; stdcall;
    function SaveEx(pIStream: IStream; dwPersistOptions: DWORD;
      fClearDirty: boolean): HResult; stdcall;
  end;
  ...
  IWICMetadataHandlerInfo = interface(IWICComponentInfo)
    ...
    function GetMetadataFormat(out pguidMetadataFormat: TGUID): HResult; stdcall;
    function GetContainerFormats(cContainerFormats: UINT;
      var pguidContainerFormats: TGUID; out pcchActual: UINT): HResult; stdcall;
    function GetDeviceManufacturer(cchDeviceManufacturer: UINT;
      var wzDeviceManufacturer: PWideChar; out pcchActual: UINT): HResult; stdcall;
    function GetDeviceModels(cchDeviceModels: UINT; var wzDeviceModels: PWideChar;
      out pcchActual: UINT): HResult; stdcall;
  ...
  IWICMetadataReaderInfo = interface(IWICMetadataHandlerInfo)
    ...
    function GetPatterns(guidContainerFormat: TGUID; cbSize: UINT;
      out pPattern: WICMetadataPattern; out pcCount, pcbActual: UINT): HResult; stdcall;
    function MatchesPattern(guidContainerFormat: TGUID; pIStream: IStream;
      out pfMatches: boolean): HResult; stdcall;
  ...
  IWICMetadataWriterInfo = interface(IWICMetadataHandlerInfo)
    ...
    function GetHeader(guidContainerFormat: TGUID; cbSize: UINT;
      out pHeader: WICMetadataHeader; out pcbActual: UINT): HResult; stdcall;
  ...
  IWICComponentFactory = interface(IWICImagingFactory)
    ...
    function CreateMetadataReader(guidMetadataFormat: TGUID;
      pguidVendor: PGUID; dwOptions: DWORD; pIStream: IStream;
      out ppIReader: IWICMetadataReader): HResult; stdcall;
    function CreateMetadataReaderFromContainer(guidContainerFormat: TGUID;
      pguidVendor: PGUID; dwOptions: DWORD; pIStream: IStream;
      out ppIReader: IWICMetadataReader): HResult; stdcall;
    function CreateMetadataWriter(guidMetadataFormat: TGUID;
      pguidVendor: PGUID; dwMetadataOptions: DWORD;
      out ppIWriter: IWICMetadataWriter): HResult; stdcall;
    function CreateMetadataWriterFromReader(pIReader: IWICMetadataReader;
      pguidVendor: PGUID; out ppIWriter: IWICMetadataWriter): HResult; stdcall;
    ...
    function CreateQueryWriterFromBlockWriter(pIBlockWriter: IWICMetadataBlockWriter;
      out ppIQueryWriter: IWICMetadataQueryWriter): HResult; stdcall;
    function CreateEncoderPropertyBag(ppropOptions: TPROPBAG2;
      cCount: UINT; out ppIPropertyBag: IPropertyBag2): HResult; stdcall;
  end;

var
  WICMatchMetadataContent: function(guidContainerFormat: TGUID;
  pguidVendor: PGUID; pIStream: IStream; out pguidMetadataFormat: TGUID): HResult;
  stdcall;
  WICSerializeMetadataContent: function(guidContainerFormat: TGUID;
  pIWriter: IWICMetadataWriter; dwPersistOptions: DWORD;
  ...
  const pixelFormat: REFWICPixelFormatGUID; hSection: THANDLE;
  stride, offset: UINT; out ppIBitmap: IWICBitmap): HResult; stdcall;
  WICMapGuidToShortName: function(guid: TGUID; cchName: UINT;
  var wzName: PWideChar; out pcchActual: UINT): HResult; stdcall;
